...
export const getApiList = (ns: t.ServiceDefinition) => {
...
export const getIdentifier = (definitions: Record<string, t.NamespaceBase>, value: string) => (
  definitions[value]
);

export const getFieldType = (field: t.FieldDefinition) => (
